  ...
  return (
    <section className="w-full min-h-[70vh] bg-green-100 flex flex-col justify-center items-center px-6 py-20">
      <div className="w-full max-w-3xl text-center">
        <h1 className="tracking-widest text-[14px] md:text-[16px] font-normal mb-4 text-[#5493d3] uppercase">
          how we work
        </h1>
        ...
        <p className="text-[16px] md:text-[18px] leading-relaxed mb-8 font-semibold text-gray-800">
